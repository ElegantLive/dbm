//v2.4
var conf = {
    appId: "tt32e44459addf13d7", //请在此行填写游戏appid
    secret: "10099464db16c868f815efd429754bb57fd1edfd", //请在此行填写指色分配的密钥
    uploadLog: "true", //不用理会
    channel: "tt", //wx, oppo, vivo, tt, qq
}
...
if (conf.channel === "wx") {
    ...
    sdk = (function () {
        ...
        self.loadCfg = function (success, fail) {
            request(cfgUrl, { appid: conf.appId }, 'POST',
                function (res) {
                    if (res.code != 200) {
                        fail(res.msg);
                    }
